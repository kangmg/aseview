...
function getBondPoints(p1, p2, sym1, sym2, atomScale, style) {
    ...
    // offsetFactor > 1.0 means bond goes into the atom
    let offsetFactor1 = 1.15;  // 15% penetration for better connection
    let offsetFactor2 = 1.15;
...
function createAtomStyleCartoon(pos, symbol, atomScale) {
    ...
    const outlineGeometry = new THREE.SphereGeometry(scaledRadius * 1.08, 32, 32);
